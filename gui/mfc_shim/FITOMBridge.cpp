// fitom/gui/mfc_shim/FITOMBridge.cpp
// MFC GUI ↔ FITOM コア ブリッジ実装
...
std::vector<FITOMDeviceInfo> FITOMBridge::getDevices() const
{
    ...
    for (int i = 0; i < n; ++i) {
        ...
        info.isEmulator  = (cfg.getDevicePort(i) != nullptr
                           && dynamic_cast<fitom::FmEnginePort*>(cfg.getDevicePort(i)) != nullptr);
